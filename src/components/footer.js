    ...
    social: [
      {
        ...
        href: '#',
        icon: (props) => (
          <svg fill="rgba(2,43,84,.7)" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
      ...
      <footer className="bg-white" aria-labelledby="footer-heading">
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                ...
                <div>
                  ...
                  <ul className="mt-4 space-y-4">
                    {navigation.solutions.map((item) => (
                      <li key={item.name}>
                        <a href={item.href} className="text-base text-blue/[.70] hover:text-gray-900">
                          {item.name}
                        </a>
                      </li>
                    ))}
          ...
          <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-base text-blue/[.3] md:mt-0 md:order-1">
              &copy; 2020 Shockmouse Media, LLC. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
